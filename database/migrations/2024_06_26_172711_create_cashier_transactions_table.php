...
return new class extends Migration
{
    ...
    {
        Schema::create('CashierTransaction', function (Blueprint $table) {
            $table->char('t_id', 9)->primary();
            $table->date('t_date');
            $table->decimal('t_TotalAmount', 10, 2);
            $table->string('t_PaymentMethod', 20);
        ...
        Schema::table('CashierTransaction', function (Blueprint $table) {
            $table->index('t_PaymentMethod', 'idx_t_payment_method');
        });
    }
